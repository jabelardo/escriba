...
import { Box, Text, Button, Card, Flex, Checkbox, Badge, Spinner } from '@radix-ui/themes'
...
export const FavoritesModelSelect = () => {
  ...
  const handleRemoveModel = useCallback((modelId: string, event: React.MouseEvent) => {
